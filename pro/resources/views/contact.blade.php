...
<head>
	<title>Ice Cream Hotel Category Bootstrap Responsive Web Template | Contact Us :: W3layouts</title>
	<!-- Meta tag Keywords -->
	...
	<div class="contact-main  w3layouts-section py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-heading text-center mb-sm-5 mb-4">
				...
				<p class="title-text font-weight-light font-italic mt-2">scoop up for some fun!!</p>
			</div>
				...
				<div class=" contact-leftgrid">
					...
					<div class="address">
						...
						<div class="row wthree-address-grid">
							...
							<div class="col-10 address-right">
								<a href="mailto:example@email.com"> glenita@gmail.com</a>
								<a href="mailto:example@email.com"> joshni@gmail.com</a>
							</div>
						</div>
						<div class="row wthree-address-grid">
							<div class="col-2 address-left">
				...
				<ul>
					...
					<li>
						<p class="text-white">
							...
							<a href="mailto:info@example.com" class="text-white">saldanha@gmail.com</a>
						</p>
					</li>
				</ul>
			</div>
